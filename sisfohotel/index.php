	...
	<div id="imgindex">
		<div id="imglog">
			...
			<div id="tentang">
				...
				<p>
					Hotel Uno adalah cabang dari OYO GROUP yang terletak di pusat kota Payakumbuh, tepatnya di Jalan Ahmad Yani No. 3. Hotel ini merupakan hotel bintang tiga yang berlokasi strategis di pusat kota.
				</p><br>
			</div>
